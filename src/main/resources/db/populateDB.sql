...
(104, '2019-08-09 10:00:00', 'Защита колена и голени SixSixOne (661) Comp Knee, размер M, White', 'OLX', 'NOVA_POST', 'CASH_ON_DELIVERY', 'SUCCESS', 740, 0, 0, 0, 0, 'Покупка упаковки'),
...
(104, '2019-08-14 10:00:00', 'Смазка цепи для сухой погоды Muc-Off Dry Lube 120 мл (новая!)', 'OLX', 'NOVA_POST', 'CASH_ON_DELIVERY', 'SUCCESS', 286, 0, 0, 0, 0, 'Покупка упаковки'),
(104, '2019-08-15 10:00:00', 'Тестер воды Xiaomi Mi TDS Pen', 'OLX', 'NOVA_POST', 'OLX_DELIVERY', 'SUCCESS', 160, 0, 0, 0, 0, 'Использована скидка НП (-6 грн.)')
